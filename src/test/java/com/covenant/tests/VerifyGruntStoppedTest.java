...
public class VerifyGruntStoppedTest extends SessionSetup {

    @Test
    @DisplayName("Verify the Grant is found and connection is lost")
    public void VerifyGruntHTTPDisconnected() {
        ...
        GruntData gruntData = new GruntData()
                ...
                .setStatus(GruntData.Status.LOST)
